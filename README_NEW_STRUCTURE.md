# VPN Server Manager - Clean v4.0.3
...
- **Multi-App Support (v4.0.3)** для параллельного запуска без конфликтов
...
python run.py
# 🌐 VPN Server Manager v4.0.3 (версия из config.json)
# 📡 Web server: http://127.0.0.1:5000 (или следующий свободный)

# Desktop режим (динамический порт v4.0.3)
