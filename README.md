...
- Прямая ссылка (v4.0.5, macOS DMG): [VPNServerManager-Clean_Installer.dmg](https://github.com/kureinmaxim/vpn-server-manager/releases/download/v4.0.5/VPNServerManager-Clean_Installer.dmg)
